...
#define WINDOW_TITLE "Pyramid" //Window title
...
const GLchar * pyramidFragmentShaderSource = GLSL(330,
        ...
        void main(){
            ...
            float highlightSize = 116.0f; //Set specular highlight size
...
void URenderGraphics(void)
{
    ...
    model = glm::rotate(model, glutGet(GLUT_ELAPSED_TIME) * -0.0005f, glm::vec3(1.0, 1.0f, 1.0f));
